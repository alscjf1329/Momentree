  ...
  sections: [
    ...
    },
    {
      ...
      fields: [
        ...
        { key: "venue.lat", type: "text", label: "위도", common: true },
        { key: "venue.lng", type: "text", label: "경도", common: true },
        { key: "venue.kakaoMapUrl", type: "text", label: "카카오맵 URL", common: true },
    ...
    },
    {
      ...
      fields: [
        ...
        { key: "envelopeClosed", type: "image", label: "봉투 (닫힘)", excludeTemplates: ["mono"] },
        { key: "envelopeOpen", type: "image", label: "봉투 (열림)", excludeTemplates: ["mono"] },
        {
          key: "gallery",
          type: "array-object",
          label: "갤러리",
